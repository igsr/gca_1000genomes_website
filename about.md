...
The goal of the 1000 Genomes Project was to find all shared genetic variation that occured at a frequency of 1% of higher in the populations studied with a false discovery rate of less than 5%.
...
Data from the pilot projects was analyzed to determine whether the low coverage strategy was adequate to meet the goals of the project.
...
The final data set contains data for 2,504 individuals from 26 populations. Low coverage and exome sequence data is present for all of these individuals, 24 individuals were also sequenced to high coverage for validation purposes.
...
The available data from the 1000 Genomes Project can be explored [on our data page](http://www.1000genomes.org/data), alongside other data in IGSR. Cell lines and DNA are avaiable for all 1000 Genomes samples and can be obtained from the [Coriell Institute](https://catalog.coriell.org). A complete list of the populations available can be found on our [Cell lines and DNA page](http://www.1000genomes.org/cell-lines-and-dna-coriell)
